  ...
  \begin{itemize}
    ...
    \item Programming Languages:\\
      	\begin{tabular}{l@{\hskip 0.5in}l}
    		...
    		C | \rating{4}{2} \\
    		SQL | \rating{4}{1} \\
    		Mathematica | \rating{4}{2} \\
		\end{tabular}
    \item Spark | \rating{4}{2}
    \item Spark Streaming | \rating{4}{2}
  \end{itemize}
\end{minipage}
...
\begin{minipage}[t]{0.50\textwidth}
	\begin{itemize}
    	\setlength{\itemsep}{-3pt}
    	\item Git | \rating{4}{1}
    	\item Linux (Ubuntu) | \rating{4}{2}
    	\item \LaTeX | \rating{4}{4}
    	\item Microsoft:\\
    	\begin{tabular}[t]{@{}l@{}}
        	Excel | \rating{4}{3} \\
        	Power BI, Access | \rating{4}{2}  \\
        	Project, Visio | \rating{4}{2}
    	\end{tabular}
    	\item AI methods for Big Data \rating{4}{3}
	\end{itemize}
\end{minipage}
